...
//   next() {
//     const currentIndexToReturn = (this.currentIndex + 1) % this.lengthOfArray;
//     this.currentIndex = currentIndexToReturn;
//     return this.array[currentIndexToReturn];
//   }

//   previous() {
//     let currentIndexToReturn = this.currentIndex - 1;
//     if (currentIndexToReturn < 0) {
//       currentIndexToReturn = this.lengthOfArray + currentIndexToReturn;
//     }
//     this.currentIndex = currentIndexToReturn;
//     return this.array[currentIndexToReturn];
//   }
...
//   step(value) {
//     let currentIndexToReturn = (this.currentIndex + value) % this.lengthOfArray;
//     if (currentIndexToReturn < 0) {
//       currentIndexToReturn = this.lengthOfArray + currentIndexToReturn;
//     }
//     this.currentIndex = currentIndexToReturn;
